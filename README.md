...
| 12 | KBZPay: rider captures the receipt, the office verifies it against the bank | **Done** — migrations 0020–0021. **Needs `public/kpay-qr.png`** |
...
**21 migrations · 186 SQL assertions across eight suites · 363 unit tests.**
