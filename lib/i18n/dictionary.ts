...
export const DICTIONARY = {
  ...
  */
  ...
  'sn.by': { en: 'by {name}', my: '{name} မှ' },
  'sn.viewDetail': { en: 'View details', my: 'အသေးစိတ် ကြည့်ရန်' },
  'sn.batchTitle': { en: 'Parcels in this pickup', my: 'ဤအကြိမ် ယူသွားသော ပါဆယ်များ' },
  'sn.deliveryTitle': { en: 'Delivery details', my: 'ပို့ဆောင်မှု အသေးစိတ်' },
  'sn.recipient': { en: 'Recipient', my: 'လက်ခံသူ' },
  'sn.collectedAmount': { en: 'Collected at the door', my: 'တံခါးဝတွင် ကောက်ခံငွေ' },
  'sn.deliveryFeeLabel': { en: 'Delivery fee', my: 'ပို့ဆောင်ခ' },
