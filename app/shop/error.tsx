...
/**
 * The shop shell's error boundary.
 *
 ...
 * not the layout beside it — so `app/shop/layout.tsx`'s I18nProvider sits
 * above this and `useT()` works.
 *
 * THE COROLLARY IS THE LIMIT OF THIS FILE: it does NOT catch a failure in
 * `app/shop/layout.tsx` itself, which is where the auth guard and the
