...
Resets a throwaway container, applies all fourteen migrations, seeds, and runs
eight SQL suites (170 assertions). **Never** point it at anything else (§0).
