...
\echo '=== 0. structural: 15 tables, 9 enums, and RLS on every one ==='
do $$
declare t int; e int;
begin
  ...
  -- trip_status enum; 0016 removed notification_outbox again. A bare count is a
  -- blunt instrument, but it is the one assertion that notices a table shipped
